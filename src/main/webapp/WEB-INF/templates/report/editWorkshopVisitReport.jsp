...
<jsp:include page="/WEB-INF/templates/report/editReportGeneralInfo.jsp" /> 
...
<!-- Answers loop -->
		...
		<c:if test="${loginRole == '[ROLE_ADMIN]'}">
			...
			<sf:input id="approvalRemarks" path="reportParts[${editReportPartNumber}].reportQuestionGroups[${questionGroupCounter.index}].answers[${questionCounter.index}].approvalRemarks" />
