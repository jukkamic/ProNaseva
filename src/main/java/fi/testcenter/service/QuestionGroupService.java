...
public class QuestionGroupService {
	...
	public void createQuestionGroups() {
		 ...
		 * 
		 * q7.setQuestion("Jäähdytysnestemäärän tarkastus"); options1.add(new
		 * MultipleChoiceOption("0 p", 0)); options1.add(new
		 * MultipleChoiceOption("1 p", 1)); options1.add(new
		 * MultipleChoiceOption("2 p", 2)); q7.setOptions(options1);
		 * questionList2.add(q7);
		 * 
		 * MultipleChoiceQuestion q9 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options2 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q9.setQuestion("Rengaspaineiden tarkastus"); options2.add(new
		 * MultipleChoiceOption("0 p", 0)); options2.add(new
		 * MultipleChoiceOption("1 p", 1)); options2.add(new
		 * MultipleChoiceOption("2 p", 2)); q9.setOptions(options2);
		 ...
		 * options3.add(new MultipleChoiceOption("0 p", 0)); options3.add(new
		 * MultipleChoiceOption("1 p", 1)); options3.add(new
		 * MultipleChoiceOption("2 p", 2)); q11.setOptions(options3);
		 * questionList2.add(q11);
		 * 
		 * MultipleChoiceQuestion q13 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options4 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q13.setQuestion("Ajovalojen suuntauksen tarkastus"); options4.add(new
		 * MultipleChoiceOption("0 p", 0)); options4.add(new
		 * MultipleChoiceOption("1 p", 1)); options4.add(new
		 * MultipleChoiceOption("2 p", 2)); q13.setOptions(options4);
		 * questionList2.add(q13);
		 * 
		 * MultipleChoiceQuestion q15 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options5 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q15.setQuestion("Äänimerkin toiminnan tarkastus"); options5.add(new
		 * MultipleChoiceOption("0 p", 0)); options5.add(new
		 * MultipleChoiceOption("1 p", 1)); options5.add(new
		 * MultipleChoiceOption("2 p", 2)); q15.setOptions(options5);
		 ...
		 * options6.add(new MultipleChoiceOption("0 p", 0)); options6.add(new
		 * MultipleChoiceOption("1 p", 1)); options6.add(new
		 * MultipleChoiceOption("2 p", 2)); q17.setOptions(options6);
		 * questionList2.add(q17);
		 * 
		 * TextareaQuestion q18 = new TextareaQuestion();
		 * q18.setQuestion("Muita huomioita"); questionList2.add(q18);
		 * 
		 ...
		 * questionGroup3.setTitle("Palvelun pisteet"); ArrayList<Question>
		 ...
		 * q19.setOptions(options7); questionList3.add(q19);
		 * 
		 * MultipleChoiceQuestion q21 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options8 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q21.setQuestion("Puhelinnumeron kysyminen"); options8.add(new
		 * MultipleChoiceOption("Aikaa varattaessa", 2)); options8.add(new
		 * MultipleChoiceOption("Huoltoon tuotaessa", 1)); options8.add(new
		 * MultipleChoiceOption("Ei kysytä", 0)); q21.setOptions(options8);
		 * questionList3.add(q21);
		 * 
		 * MultipleChoiceQuestion q23 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options9 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q23.setQuestion("Lupa lisätöihin"); options9.add(new
		 * MultipleChoiceOption( "Soitetaan tai kysytään huoltoon tuotaessa",
		 * 2)); options9.add(new MultipleChoiceOption("Ei kysytä", 0));
		 * q23.setOptions(options9); questionList3.add(q23);
		 * 
		 * MultipleChoiceQuestion q25 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options10 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q25.setQuestion("Työmääräyksen allekirjoitus"); options10.add(new
		 * MultipleChoiceOption("Pyydetään allekirjoitus", 2));
		 * options10.add(new MultipleChoiceOption(
		 * "Ei pyydetä/pyydetään huollon jälkeen", 0));
		 * q25.setOptions(options10); questionList3.add(q25);
		 * 
		 * MultipleChoiceQuestion q27 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options11 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q27.setQuestion("Työmääräyksen läpikäynti"); options11 .add(new
		 * MultipleChoiceOption(
		 * "Varmistetaan ajanvarauksessa sovitut asiat paperilta",
		 * "Varmistetaan ajanvarauksessa <br> sovitut asiat paperilta", 2));
		 ...
		 * "Ei varmisteta mitään <br> &nbsp", 0)); q27.setOptions(options11);
		 * questionList3.add(q27);
		 * 
		 * MultipleChoiceQuestion q29 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options12 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q29.setQuestion("Aikataulussa pysyminen"); options12.add(new
		 * MultipleChoiceOption("Sovittu aika", 2)); options12 .add(new
		 * MultipleChoiceOption("Ilmoitetaan myöhästymisestä", 1));
		 * options12.add(new MultipleChoiceOption("Huolto myöhästyy", 0));
		 * q29.setOptions(options12); questionList3.add(q29);
		 * 
		 * MultipleChoiceQuestion q31 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options13 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q31.setQuestion("Laskun läpikäynti"); options13.add(new
		 * MultipleChoiceOption("Käydään läpi riveittäin", 2));
		 * options13.add(new MultipleChoiceOption("Pääpiirteittäin", 1));
		 * options13.add(new MultipleChoiceOption("Ei ollenkaan", 0));
		 * q31.setOptions(options13); questionList3.add(q31);
		 * 
		 * MultipleChoiceQuestion q33 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options14 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q33.setQuestion("Huollon tarkastuslistan täyttö"); options14.add(new
		 * MultipleChoiceOption("Täydellisesti", "Täydellisesti <br> &nbsp",
		 * 2)); options14.add(new MultipleChoiceOption(
		 ...
		 * "Ei saada ollenkaan <br> &nbsp", 0)); q33.setOptions(options14);
		 * questionList3.add(q33);
		 * 
		 * MultipleChoiceQuestion q35 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options15 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q35.setQuestion("Kustannusarviossa pysyminen"); options15.add(new
		 * MultipleChoiceOption("Sovittu summa", 2)); options15.add(new
		 * MultipleChoiceOption("Ylittyy alle 15%", 1)); options15.add(new
		 * MultipleChoiceOption("Ylittyy yli 15", 0));
		 * q35.setOptions(options15); questionList3.add(q35);
		 * 
		 * MultipleChoiceQuestion q37 = new MultipleChoiceQuestion();
		 * ArrayList<MultipleChoiceOption> options16 = new
		 * ArrayList<MultipleChoiceOption>();
		 * q37.setQuestion("Asiakaspalvelun toiminta"); options16.add(new
		 * MultipleChoiceOption("Hyvä", 2)); options16.add(new
		 * MultipleChoiceOption("Tyydyttävä", 1)); options16.add(new
		 * MultipleChoiceOption("Heikko", 0)); q37.setOptions(options16);
		 * questionList3.add(q37);
		 * 
		 * TextareaQuestion q38 = new TextareaQuestion();
		 * q38.setQuestion("Muita huomioita"); questionList3.add(q38);
		 * 
