...
public class Report {
	...
	private boolean approvalRemarksGiven = false;

	private String reportStatus; // 'DRAFT', 'AWAIT_APPROVAL', 'APPROVED',
									// 'REJECTED'
	...
	public boolean isApprovalRemarksGiven() {
		return approvalRemarksGiven;
	}

	public void setApprovalRemarksGiven(boolean approvalRemarksGiven) {
		this.approvalRemarksGiven = approvalRemarksGiven;
	}
