...
public class AutokeskusWorkshopTestReportTemplate {
	...
	public static WorkshopVisitReportTemplate getReportTemplate() {
		...
		reportTemplate.setTemplateName("Autokeskus korjaamotesti");
		...
		e7 = new MultipleChoiceQuestion();
		optionsE7 = new ArrayList<MultipleChoiceOption>();
		e7.setQuestion("Lisätöissä/korjauksissa käytettyjen varaosien vaihtotarpeen peruste kirjattu työmääräykseen");
		optionsE7.add(new MultipleChoiceOption("Kyllä", -1));
		optionsE7.add(new MultipleChoiceOption("Ei", -1));
		e7.setOptionsList(optionsE7);
		questionList18.add(e7);
	...
	private static List<Question> getOptionalQuestions() {
